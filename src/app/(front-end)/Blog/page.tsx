          ...
          >
            {row.map((post, postIndex) => (
              <div key={postIndex} className="flex flex-col">
                ...
                <a href={`article/${post.slug}.html`} className="text-xl font-medium mb-3 hover:text-gray-600">
                  {post.title}
                </a>
                <p className="text-gray-600 mb-3">{post.description_html}</p>
                <a
                  href={`article/${post.slug}.html`}
